...
export default function SubjectList() {
    ...
    const getSubjectsData = async () => {
        ...
        let getSG11 = await getDocs(collection(db, 'Subjects', '11', 'SG'));
        let arr1 = []
        ...
        let getSG12 = await getDocs(collection(db, 'Subjects', '12', 'SG'));
        let arr2 = []
        ...
        let getPE11 = await getDocs(collection(db, 'Subjects', '11', 'PE'));
        let arr3 = []
        ...
        let getPE12 = await getDocs(collection(db, 'Subjects', '12', 'PE'));
        let arr4 = []
...
try {
    await deleteDoc(doc(db, "Subjects", `${className}`, `${group == "Science General" ? "SG" : group == "Pre Engineering" ? "PE" : ''}`, id))
    // getSubjectsData()
    setRefresh(!refresh)
    setError(false)
} catch (error) {
